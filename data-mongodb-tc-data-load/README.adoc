...
[, javascript]
----
include::src/test/resources/mongo-init.js[]
----
...
[, java]
----
include::src/test/java/zin/rashidi/data/mongodb/tc/dataload/user/UserRepositoryTests.java[lines=27..28]
----
...
[, java]
----
include::src/test/java/zin/rashidi/data/mongodb/tc/dataload/user/UserRepositoryTests.java[lines=27..29]
----
...
[,java]
----
include::src/test/java/zin/rashidi/data/mongodb/tc/dataload/user/UserRepositoryTests.java[lines=21..52]
----
