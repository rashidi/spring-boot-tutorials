...
** xref:data-jdbc-optimistic-locking.adoc[JDBC Optimistic Locking]
...
** xref:modulith-events.adoc[Event Publication Registry with PostgreSQL]
* jOOQ
** xref:jooq.adoc[jOOQ]
* Spring Test
...
** xref:web-thymeleaf-xss.adoc[Cross-Site Scripting (XSS) with Thymeleaf]
