...
`UserController` exposes a REST endpoint to query database records and return thread information, proving the request runs on a virtual thread despite making a blocking I/O call:
