...
Spring Modulith automatically generates documentation for your modules. You can view the generated documentation in the link:${url-quickref}/docs/all-docs.adoc[docs/all-docs.adoc] file.
