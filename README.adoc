...
|link:ai-neo4j[Spring AI: Vector Similarity Search with Neo4j] |Semantic vector similarity search using Spring AI and Neo4j Vector Store with Testcontainers
|link:ai-pgvector[Spring AI: Vector Similarity Search with PgVector] |Semantic vector similarity search using Spring AI and PostgreSQL pgvector with Testcontainers
|link:ai-redis[Spring AI: Vector Store with Redis] |Semantic vector similarity search using Spring AI and Redis Vector Store with Testcontainers
...
|link:web-problem-details[Spring Web: Problem Details for HTTP APIs] |Return Problem Details for HTTP APIs (RFC 7807) in Spring Boot
...
|link:web-virtual-threads[Spring Web: Virtual Threads] |Enable Virtual Threads in Spring Boot to handle high concurrency with blocking I/O
|===