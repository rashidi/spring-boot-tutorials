...
image:https://img.shields.io/badge/Spring_Boot-4.1.0-blue?style=flat-square&logo=springboot[Spring Boot version]
...
with https://plugins.gradle.org/plugin/org.springframework.boot/4.1.0[Spring Boot 4.1.0].
