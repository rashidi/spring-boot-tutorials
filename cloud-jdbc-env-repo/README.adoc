...
[source,sql]
----
include::src/test/resources/init-script.sql[lines=1..9]
----
...
[source,sql]
----
include::src/test/resources/init-script.sql[lines=11..13]
----
...
[source,java]
----
include::src/main/java/zin/rashidi/boot/cloud/jdbcenvrepo/greet/GreetResource.java[lines=10..24]
----
...
[source,java]
----
include::src/test/java/zin/rashidi/boot/cloud/jdbcenvrepo/CloudJdbcEnvRepoApplicationTests.java[lines=15..33]
----
