...
[source,java]
----
include::src/test/java/zin/rashidi/boot/test/restassured/user/CreateUserTests.java[lines=28..84]
----
...
[source,java]
----
include::src/test/java/zin/rashidi/boot/test/restassured/user/FindUserByUsernameTests.java[lines=28..70]
----
...
[source,java]
----
include::src/test/java/zin/rashidi/boot/test/restassured/user/DeleteUserTests.java[lines=28..66]
----
...
[source,java]
----
include::src/test/java/zin/rashidi/boot/test/restassured/user/DeleteUserTests.java[lines=28..31]
    //remove for brevity

include::src/test/java/zin/rashidi/boot/test/restassured/user/DeleteUserTests.java[lines=45..48]

        //remove for brevity

include::src/test/java/zin/rashidi/boot/test/restassured/user/DeleteUserTests.java[lines=54..55]
----
...
----
include::src/main/java/zin/rashidi/boot/test/restassured/user/UserResource.java[lines=23..31]
include::src/main/java/zin/rashidi/boot/test/restassured/user/UserResource.java[lines=47..51]
include::src/main/java/zin/rashidi/boot/test/restassured/user/UserResource.java[lines=62..63]
----
