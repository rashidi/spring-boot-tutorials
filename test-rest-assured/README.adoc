...
[source,java]
----
include::src/test/java/zin/rashidi/boot/test/restassured/user/DeleteUserTests.java[lines=28..65]
----
...
include::src/test/java/zin/rashidi/boot/test/restassured/user/DeleteUserTests.java[lines=44..47]

        //remove for brevity

include::src/test/java/zin/rashidi/boot/test/restassured/user/DeleteUserTests.java[lines=53..54]
----
