...
== Verification
Given we have the following entries in link:src/main/java/zin/rashidi/boot/data/mongodb/character/Character.java[Character]:
...
This is demonstrated in link:src/test/java/zin/rashidi/boot/data/mongodb/character/CharacterRepositoryTests.java[CharacterRepositoryTests].
...
Without predefined index, we will need to implement a custom repository implementation. We will start by defining a custom repository interface, link:src/main/java/zin/rashidi/boot/data/mongodb/character/CharacterSearchRepository.java[CharacterSearchRepository]:
...
Next, implement the custom repository interface in link:src/main/java/zin/rashidi/boot/data/mongodb/character/CharacterSearchRepositoryImpl.java[CharacterSearchRepositoryImpl]:
